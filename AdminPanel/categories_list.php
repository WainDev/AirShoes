...
$sql = "SELECT Id, NameCategories, Priority FROM Categories";
  ...
  <div class="d-flex  text-center align-items-start">
    ...
    <div class="container">
      <div class="admins_list mt-5 shadow-lg p-3 mb-5 bg-body rounded">
        ...
        <form action="./Config/assets_config/сategories/add_сategories.php">
        ...
        <?php
          if ($result->rowCount() > 0) {
            while ($row = $result -> fetch(PDO::FETCH_ASSOC)) {
              ...
              echo "<li>" . $row['Id'] . "</li>";
              echo "<li>" . $row['NameCategories'] . "</li>";
              echo "<li>" . $row['Priority'] . "</li>";
              echo "<li class='d-block'>";
              echo "<a href='./Config/assets_config/сategories/update_сategories.php?id=" . $row['Id'] . "'><img src='./Assets/image/pencil.svg' /></a>";
              echo " <a href='./Config/assets_config/сategories/delete.php?id=" . $row['Id'] . " '><img src='./Assets/image/close.svg' /></a>";
              echo "</li>";
              echo "</ul>";
            } 
          } else {

...
$sql = "SELECT Id, NameBrands, ImgUrl, Priority FROM Brands";
  ...
  <div class="d-flex text-center align-items-start">
    ...
    <div class="container">
      <div class="admins_list mt-5 shadow-lg p-3 mb-5 bg-body rounded">
        ...
        <form action="./Config/assets_config/brands/add_brands.php">
        ...
        <?php
          if ($result->rowCount() > 0) {
            while ($row = $result -> fetch(PDO::FETCH_ASSOC)) {
              ...
              echo "<li>" . $row['Id'] . "</li>";
              echo "<li>" . $row['NameBrands'] . "</li>";
              echo "<li>" . $row['ImgUrl'] . "</li>";
              echo "<li>" . $row['Priority'] . "</li>";
              echo "<li class='d-block'>";
              echo "<a href='./Config/assets_config/brands/update_brands.php?id=" . $row['Id'] . "'><img src='./Assets/image/pencil.svg' /></a>";
              echo " <a href='./Config/assets_config/brands/delete.php?id=" . $row['Id'] . " '><img src='./Assets/image/close.svg' /></a>";
              echo "</li>";
              echo "</ul>";
            } 
          } else {

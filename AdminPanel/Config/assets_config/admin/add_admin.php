    ...
    if (!class_exists('Database')) {
        ...
        if (!$db->getConnection()) {
            ...
            if (!empty($_POST['login']) && !empty($_POST['password'])) {
                ...
                $stmt = $conn->prepare("INSERT INTO `Admin` (`Id`, `Login`, `Password`) VALUES (NULL, :login, :password)");
    ...
    <div class="container">
        <div class="admins_list mt-5 shadow-lg p-3 mb-5 bg-body rounded">
            <div class="header_form d-flex align-items-center justify-content-between p-2">
                <h1>Добавление администраторов</h1> <a href="/AdminPanel/index.php"><img src="../../../Assets/image/close.svg" alt=""></a>
            </div>
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="admins_form">
                <input class="admin_input" type="text" name="login" placeholder="Логин" />
                <input class="admin_input" type="text" name="password" placeholder="Пароль" />
